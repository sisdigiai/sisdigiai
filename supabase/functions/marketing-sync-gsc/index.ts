...
Deno.serve(async (req: Request) => {
  ...
  if (!cred) {
    return jsonResp({
      ...
      configured: false,
      provider: PROVIDER,
      message: "Credenciais GSC não cadastradas. Veja a doc para gerar OAuth refresh token.",
      doc: SETUP_DOC,
    }, 503);
  }
  ...
  return jsonResp({
    ...
    todo: "stub — sync real será implementado em F5 (briefing AGENT_PROMPT_marketing-seo-module.md)",
  });
});
