...
const ITEMS: Item[] = [
  ...
  { id: 'marketing', label: 'Calendário', group: 'Marketing' },
  { id: 'marketing-redes', label: 'Redes', group: 'Marketing' },
  { id: 'marketing-performance', label: 'Performance', group: 'Marketing' },
  { id: 'marketing-banco', label: 'Banco de Ideias', group: 'Marketing' },
  { id: 'marketing-prompts', label: 'Prompts IA', group: 'Marketing' },
