...
export function CardBing() {
  ...
  return (
    ...
    >
      {!hasAny ? (
        <EmptyHint>Clique <strong className="text-on-surface-variant">Sincronizar</strong> para carregar. O Bing reporta dados alguns dias após a indexação.</EmptyHint>
      ) : (
