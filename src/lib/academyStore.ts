...
function defaultProduct(): AcademyProduct {
  return {
    ...
    core_delivery: 'PDF visual principal + app de apoio + scripts de WhatsApp + respostas para objecoes + ponte para o ecossistema de apps.',
    current_focus: 'Rodar OSI como isca paga, capturar compradores qualificados e mapear dores para ascensao ao produto principal.',
    notes: 'O guia resolve uma parte da dor. O ecossistema de apps resolve a rotina. Nexus entra como apoio e continuidade.',
    sales_page_url: '',
    checkout_url: '',
    delivery_mode: 'nexus',
  ...
  return [
    {
      ...
      title: 'Arquitetura do ecossistema de apps para oticas',
      status: 'ready',
      content_md: '',
    ...
    },
    {
      ...
      notes: 'Recupera venda e qualifica dor para o ecossistema de apps.',
      metadata: {},
    },
  ];
}
...
function defaultScenarios(): AcademyScenario[] {
  return [
    ...
    },
    {
      ...
      notes: 'Cada guia deve ter easter eggs do ecossistema de apps.',
      sort_order: 20,
    },
    {
      id: crypto.randomUUID(),
