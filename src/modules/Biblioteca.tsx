...
const DOCS: DocEntry[] = [
  ...
  { titulo: 'Pricing Clearix', path: 'docs/04-comercial/pricing-clearix.md', categoria: 'comercial', descricao: 'Essencial R$ 349 · Controle R$ 899 · Crescimento R$ 1.499 · Completo sob consulta (por mês). Sem período grátis, sem % off; implantação e migração orçadas à parte após amostra. Fonte: iam.clearix_packages + termo D7, 15/09.', status: 'canonico-inicial', revisao: '2026-09-15' },
  ...
  { titulo: 'Plano Mestre de Marketing', path: 'docs/05-marketing/plano-mestre-marketing.md', categoria: 'marketing', descricao: 'RAIZ do marketing: arquitetura de marca/canais, funil OSI->Clearix, sistema de conteúdo, oferta, enxame/afiliados, KPIs e playbook passo a passo.', status: 'validado', revisao: '2026-05-29' },
  { titulo: 'OSI - Artes & Promoções', path: 'docs/05-marketing/produtos/otica-sem-improviso/artes-promocoes-osi.md', categoria: 'marketing', descricao: 'Direção de arte (templates Reel/Carrossel/Stories, voz Taty) + mecânica de promoção/lançamento (estreia, régua de preço, recuperação, afiliados).', status: 'validado', revisao: '2026-05-29' },
  { titulo: 'OSI - Roteiros de Vídeo (Taty + Depoimentos)', path: 'docs/05-marketing/produtos/otica-sem-improviso/roteiros-video-depoimentos.md', categoria: 'marketing', descricao: 'Roteiros: VSL/autoridade da Taty + roteiro-guia para coletar depoimentos REAIS (humano, específico, LGPD/termo de imagem).', status: 'validado', revisao: '2026-05-29' },
  { titulo: 'OSI - Plano de Largada (passo a passo)', path: 'docs/05-marketing/produtos/otica-sem-improviso/plano-de-largada-osi.md', categoria: 'marketing', descricao: 'Modelo de largada travado: organico-first + afiliados (boca a boca 51%) + R$50/dia amplificando vencedor + Taty cara. Passo a passo do lançamento 01/06.', status: 'validado', revisao: '2026-05-29' },
  { titulo: 'Plano DIGIAI Academy', path: 'docs/05-marketing/plano-clearix-academy.md', categoria: 'marketing', descricao: 'Funil, temas, operação editorial, low tickets, CTA para o ecossistema. (arquivo aguarda rename — ADR-0037)', status: 'canonico-inicial', revisao: '2026-04-16' },
