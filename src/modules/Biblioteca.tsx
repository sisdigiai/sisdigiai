...
const DOCS: DocEntry[] = [
  ...
  { titulo: 'Pricing Clearix', path: 'docs/04-comercial/pricing-clearix.md', categoria: 'comercial', descricao: 'Essencial R$ 349 · Controle R$ 899 · Crescimento R$ 1.499 · Completo sob consulta (por mês). Sem período grátis, sem % off, sem setup. Fonte: iam.clearix_packages (banco do Clearix), 15/09.', status: 'canonico-inicial', revisao: '2026-09-15' },
