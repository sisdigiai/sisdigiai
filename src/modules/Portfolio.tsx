...
const APPS: App[] = [
  ...
  },
  {
    ...
    repos: 'pulso_control (app) · pulso_hub (site público, protótipo)',
    git: 'control 5fac8e3 07/jul · hub 7d3e072 29/jun',
    proximo: 'Manter a fila de vídeos prontos · publicar o Pulso Hub',
    bloqueio: 'Site público (hub) ainda sem domínio definido',
    urls: [],
  },
  {
    ...
    bloqueio: 'URL pública a confirmar; falta oferta comercial',
    urls: [],
  },
  {
  ...
  },
  {
    ...
    urls: [{ label: 'polapetit.com.br', url: 'https://polapetit.com.br' }, { label: 'app', url: 'https://polapettiapp.netlify.app' }],
  },
  {
    nome: 'Qual a Foto', mono: 'QF', cor: 'var(--color-eco-qualafoto)', tagline: 'Aprovação de fotos para fotógrafos',
    tier: 'incubacao', estado: 'funciona', maturidade: 45, funcao: 'Web funciona local · worker IA é local',
    ...
    proximo: 'Fechar UI de galeria · deploy do web · confirmar worker IA',
    bloqueio: 'Worker de processamento é local; deploy do web não confirmado',
    urls: [],
  },
  {
    nome: 'Easy Idiomas', mono: 'EI', cor: 'var(--color-muted)', tagline: 'SaaS para escolas de idiomas',
    tier: 'incubacao', estado: 'travado', maturidade: 25, funcao: 'Schema/RLS prontos · sem deploy',
    stack: 'React 19 · Vite · TS · Supabase · Gemini',
    repos: 'D:\\projetos\\easy-idiomas',
    git: 'e0538bf 29/mai/2026 · 11 pendências',
    proximo: 'Definir plataforma de deploy e validar oferta com escolas',
  ...
  },
  {
    ...
    tier: 'institucional', estado: 'travado', maturidade: 50, funcao: 'Piloto v4.1 · bug ativo em profiles',
