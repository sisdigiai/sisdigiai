...
const PRODUTOS: Produto[] = [
  ...
  },
  {
    ...
    categoria: 'autonomo',
    prioridade: 'baixa',
    status: '✅ Produção — publicando (5 vídeos × 4 redes, 10/06) · auth/PWA/financeiro/analytics',
    faseAtual: 'Produção · autônomo (fora do ecossistema Clearix, ADR-0040)',
    repo: 'D:\\projetos\\pulso_control',
    stack: 'Next.js 16 · React 19 · Supabase · pg_cron · OpenAI/Claude · ElevenLabs · Higgsfield',
    proximo: 'Operar como produto autônomo (NÃO é motor do Academy — decidido em ADR-0040)',
  },
  {
    nome: 'Polapetit',
