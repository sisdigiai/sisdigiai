...
--
-- ✔ APLICADA em 21/09/2026 às 23:26:56 BRT, com a palavra do dono neste canal (card OSI "nas duas" telas), reensaiada antes.
--   Medido antes→depois (21/09, total histórico): osi 163→123 · clearix-site 52→47 (em 17/09 era 151; caiu antes desta, fora dela) ·
--   clearix-calc 43→43 · osi-leitor 1→0. v_mkt_osi_dias: 90 dias, 86 visitas, 55 sessões, 0 comprar, 0 vendas. 0 linhas prova146 no banco.
--
